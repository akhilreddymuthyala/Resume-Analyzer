...
# ============================================================================
# CRITICAL: Import ImprovedTextPreprocessor and create alias for pickle
# This allows pickle files to find the class without retraining
# ============================================================================

from preprocessor import ImprovedTextPreprocessor

# Create alias in __main__ namespace for pickle compatibility
import sys
sys.modules['__main__'].ImprovedTextPreprocessor = ImprovedTextPreprocessor

logger.info("✓ ImprovedTextPreprocessor imported and aliased successfully")
